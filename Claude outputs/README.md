...
> Documentación funcional y técnica detallada en [`Documentos/`](./Documentos/): `ARQUITECTURA.md`, `FUNCIONALIDADES.md`, `ERRORES.md`, `MEJORAS.md`, `DESPLIEGUE.md` — actualizados el 19 de septiembre de 2026.
...
│   └── api/                      # Rutas API (login por cédula, invitaciones, altas directas, sesión)
...
│   ├── maps/map-floor.tsx        # Plano interactivo del piso de bodega
...
│   ├── auth-context.tsx          # Contexto de sesión (incluye modo demo — ver ERRORES.md)
