 ...
 * analítica operacional (`@/frontend/services/analytics`): mide, con datos reales de la
...
import { LatencyHistogram } from "@/frontend/components/charts/latency-histogram";
import { DailyTrend } from "@/frontend/components/charts/daily-trend";
