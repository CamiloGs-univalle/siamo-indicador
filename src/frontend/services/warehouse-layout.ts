 ...
 * mapa — el fondo real es `@/frontend/services/warehouse-floorplan`, que recrea el plano
 ...
 * real (`@/frontend/services/warehouse-floorplan`), que ubica la zona nueva dentro del
